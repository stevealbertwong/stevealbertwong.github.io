...
Personally I find this explanation more intuitive. If you understand how to computing pagerank, this should be rather straightforward.
...
\\(XV\\) is projection length of all data points \\(x_i\\) onto 3 new coordinate lines spanned by \\(V\\). Each entry is dot products \\( x_i \cdot v_i \\). The squared norm \\( ||XV|| \\) denotes sum of squared lengths of projections of data onto line spanned by \\(v\\)
...
[here](https://inst.eecs.berkeley.edu/~ee16a/sp17/lecture/Note_Lin_Alg_Release10.pdf)
